-- SQL (Module 9.2) and SQL Homework 
-- UCB Coding-Bootcamp, UCBSAN201811DATA@
-- Instructor: Aash Anand 
-- TA: Allen LU
-- February 2, 2019.alter
-- **********************************************************
...
--  the data type BLOB (Make sure to research the type BLOB, as the difference between it 
